...
trait InstallsApiStack
{
    ...
    protected function installApiStack()
    {
        ...
        $this->replaceInFile(
            "'url' => env('APP_URL', 'https://8000-hnsek-registerbreeze1-6ebx8za0003.ws-us54.gitpod.io/')",
            "'url' => env('APP_URL', 'https://8000-hnsek-registerbreeze1-6ebx8za0003.ws-us54.gitpod.io/'),".PHP_EOL.PHP_EOL."    'frontend_url' => env('FRONTEND_URL', 'http://localhost:3000')",
            config_path('app.php')
        );
